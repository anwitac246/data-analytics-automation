        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="relative mb-16 max-w-4xl mx-auto">
            ...
            >
              ...
              <div className={`relative border-2 border-dashed rounded-3xl p-20 transition-all duration-500 ${
                dragActive 
                ...
                <div className="text-center">
                  <div className="mb-8 relative">
                    <div className={`w-20 h-20 mx-auto rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center transition-all duration-500 ${
                      dragActive ? 'scale-125 rotate-12' : 'group-hover:scale-110 group-hover:rotate-6'
                    }`}>
